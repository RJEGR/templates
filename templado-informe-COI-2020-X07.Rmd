...
```{r Figura 12. Diversity, fig.align = "center", fig.cap = "Figura 12. Analisis de diversidad por estación. Se muestran los índices de diversidad calculados para la comunidad de zooplancton cada estación.", out.width='\\textwidth', fig.width = 7, fig.height = 5}
