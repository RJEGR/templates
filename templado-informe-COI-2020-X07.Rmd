...
La diversidad se obtuvo a través del cálculo de los índices de Shannon, Chao y Predicted de cada estación (Figura 12). La figura 12 grafica la dispersión de la riqueza de especies observadas versus la riqueza predicha utilizando los estimadores ICE (A-C) y Chao2 (D-F) para las estaciones muestradas. Los colores de los puntos representan el indice de diversidad Shannon para cada estación. La línea punteada muestra la relación 1 a 1 entre la riqueza observada y predicha. Los valores de indices de diversidad alfa puede encontrarse en la tabla 1.
