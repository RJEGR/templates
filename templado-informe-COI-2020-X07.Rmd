...
* Figura 5. Composición de la comunidad a nivel Filo (heatmap).
* Figura 6. Composición de la comunidad a nivel Clase (heatmap).
* Figura 7. Composición de la comunidad a nivel Orden (heatmap)
* Figura 8.  Composición de las comunidades a nivel Familia a lo largo de las estaciones. espectivamente, se indican el nivel de Filos y Clase en las columnas del panel derecho
...
physeq %>% 
  ...
  subset_taxa(!Clase %in%  c('Arachnida', 'Mammalia', 'Insecta')) %>%
...
caption <- paste0("La categoria 'Others' contiene ASVs sin asignacion taxonomica")
...
caption <- paste0("La categoria 'Others' contiene ASVs sin asignacion taxonomica y con RA < ", fra, " %")
