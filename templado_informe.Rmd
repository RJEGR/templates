...
```{r, echo = FALSE, fig.align = "center", fig.cap = "El número de secuencias totales, secuencias de buena calidad, secuencias Alineadas (quimeras removidas)  y secuencias clasificadas a lo largo de las estaciones.", out.width='\\textwidth'}
